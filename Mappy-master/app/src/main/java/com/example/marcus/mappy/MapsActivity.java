    ...
    public void onConnected(Bundle bundle) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                User tmpUser = model.getUser();
                Fragment frag = FriendFrag.newInstance(tmpUser);
...
//        Log.d("location", "Yo " + mLastLocation.toString());
    ...
    public void syncTaskSendLocation() {
        ...
        TimerTask doSendSyncTask = new TimerTask() {
            ...
            public void run() {
                handler.post(new Runnable() {
                    public void run() {
                        try {
                            InternetManager backTask = new InternetManager(model.getUser());
        ...
        timer.schedule(doSendSyncTask, 0, 4000); //execute in every 50000 ms
    }
    ...
    public void syncFriendsLocation() {
        ...
        TimerTask doSyncFriends = new TimerTask() {
            @Override
            public void run() {
                final InternetManager backTask = new InternetManager(model.getUser());
                handler.post(new Runnable() {
                    public void run() {
                        try {
                ...
                model.updateFriends(backTask.getFriendList());
            }
        };
        timer2.schedule(doSyncFriends, 0, 4000); //execute in every 50000 ms
    }
